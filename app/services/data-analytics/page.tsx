  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <main className="pt-nav">
        <div className="relative bg-gradient-to-b from-gray-50 to-white pt-12 pb-16 text-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Solutions Section */}
            <section id="solutions" className="py-16 bg-white/50 relative overflow-hidden">
              <div className="absolute inset-0 pointer-events-none">
            ...
            {/* Technology Section */}
            <section className="py-16 bg-gradient-to-br from-orange-50 to-blue-50 relative overflow-hidden">
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-10 right-10 w-40 h-40 bg-gradient-to-br from-orange-200/20 to-blue-200/20 rounded-full blur-2xl animate-pulse" />
                <div className="absolute bottom-10 left-10 w-32 h-32 bg-gradient-to-br from-purple-200/20 to-orange-200/20 rounded-full blur-xl animate-pulse" />
              </div>
            ...
            {/* CTA Section */}
            <section className="py-16 text-center bg-gradient-to-br from-orange-600 to-blue-600 text-white relative overflow-hidden">
              <div className="absolute inset-0 pointer-events-none">
